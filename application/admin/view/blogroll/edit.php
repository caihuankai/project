    ...
    <form class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                ...
                <input type="text" class="input-text" value="<{$info.media_name}>" placeholder="名称" id="media_name" name="media_name" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>URL</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="<{$info.path_url}>" placeholder="URL" id="path_url" name="path_url" maxlength="255">
            </div>
        </div>
        <div class="row cl">
