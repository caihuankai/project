...
<form action="#" class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid input-short" placeholder="" autoComplete="Off" name="cost" value="<{$data['cost']}>" id="cost">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid input-short" placeholder="" autoComplete="Off" name="denomination" value="<{$data['denomination']}>" id="denomination">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid input-short" placeholder="" autoComplete="Off" name="bonus" value="<{egt name="data.bonus" value="1" }><{$data['bonus']}><{/egt}>" id="bonus">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<select title="类型" name="type" id="select-type" class="form-control form-select">
		        <{option data="$typeArr" notHeader="true" selected="$data['type']"}>
		    </select>
		</div>
	</div>
