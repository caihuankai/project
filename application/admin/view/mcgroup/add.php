    ...
    <form action="" method="post" class="form form-horizontal" id="form-add"
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="form_table">
            ...
            <tr>
                ...
                <td width="75%">
                    <input type="text" class="input-text" style="width: 516px;" id="group_name" name="group_name"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="75%">
                    <textarea class="form-control" rows="3" style="width: 516px;" id="group_desc" name="group_desc"></textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="75%">
                    ...
                    <div style="margin-top: 5px;position: absolute;top: 180px;left: 264px;">
                        <input readonly type="text" class="input-text" style="width: 384px;" id="tmp_group_icon" name="tmp_group_icon"/>
                        <input hidden type="text" class="input-text" style="width: 384px;" id="group_icon" name="group_icon"/>
                    </div>
                </td>
            </tr>
            ...
            <tr>
            <td width="25%" height="30" align="right">显示在广场：</td>
            <td width="75%">
