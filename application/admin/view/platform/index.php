...
<div class="page-container">
  <div class="text-c">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="输入AppId" id="app_id" name="app_id">
    <span>

    </span>
    <button type="submit" onclick="javascript:$('button[name=\'refresh\']').click();" class="btn btn-success radius" id="" name="">
      <i class="Hui-iconfont">&#xe665;</i>搜索大咖</button></div>
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    <div id="toolbar" class="btn-group">   
      <button onclick="member_add('添加服务号',['./add','no'],'','510')" type="button" class="btn btn-success" style="margin-right:10px;">　新增　</button>><button disabled id="btn_delete" type="button" class="btn btn-danger" title="请先选中要删除的菜单">　删除　</button></div>
    <div class="mt-20">
...
<script type="text/javascript">
    ...
    /*绑定大咖*/
    function bindDaka(platformId) {
      layer_show('绑定大咖','./dakalist?platformId='+platformId , '850');
    }
</script>