...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <select name="relevanceType" id="relevanceType" class="form-control form-select" >
            <{if $data['relevanceType'] eq 7 && !in_array($positionType,[19,18,16,15,10,13,12,11,21,22])}>
            ...
            <{/if}>
            <{if $data['relevanceType'] eq 4 && !in_array($positionType,[19,18,16,15,10,13,12,11,21,22])}>
                ...
                <option value="6">讲师介绍页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 9 && !in_array($positionType,[19,18,16,15,10,13,12,11,21,22])}>
                <option value="7">外链</option>
                <option value="4">专题课介绍页</option>
                ...
                <option value="6">讲师介绍页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 10 && !in_array($positionType,[19,18,16,15,10,13,12,11,21,22])}>
                <option value="7">外链</option>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                ...
                <option value="6">讲师介绍页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 11 && !in_array($positionType,[19,18,16,15,10,13,12,11,21,22])}>
                <option value="7">外链</option>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
                ...
                <option value="6">讲师介绍页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 12 && !in_array($positionType,[19,18,16,15,10,13,12,11,21,22])}>
                <option value="7">外链</option>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
                ...
                <option value="6">讲师介绍页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 6 && !in_array($positionType,[19,18,16,15,10,13,12,11,21,22])}>
                <option value="7">外链</option>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
            ...
            <{if $data['relevanceType'] eq 7 && in_array($positionType,[19,18,16,15,10,13,11,22])}>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
                <option value="11">特训班详情页</option>
                <option value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 4 && in_array($positionType,[19,18,16,15,10,13,11,22])}>
                <option selected="selected" value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
                <option value="11">特训班详情页</option>
                <option value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 9 && in_array($positionType,[19,18,16,15,10,13,11,22])}>
                <option value="4">专题课介绍页</option>
                <option selected="selected" value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
                <option value="11">特训班详情页</option>
                <option value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 10 && in_array($positionType,[19,18,16,15,10,13,11,22])}>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option selected="selected" value="10">特训班预告页</option>
                <option value="11">特训班详情页</option>
                <option value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 11 && in_array($positionType,[19,18,16,15,10,13,11,22])}>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
                <option selected="selected" value="11">特训班详情页</option>
                <option value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 12 && in_array($positionType,[19,18,16,15,10,13,11,22])}>
                <option value="4">专题课介绍页</option>
                <option value="9">系列课介绍页</option>
                <option value="10">特训班预告页</option>
                <option value="11">特训班详情页</option>
                <option selected="selected" value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 10 && in_array($positionType,[12,21])}>
                <option selected="selected" value="10">特训班预告页（详情页）</option>
                <!-- <option value="11">特训班详情页</option> -->
                <option value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 11 && in_array($positionType,[12,21])}>
                <option value="10">特训班预告页</option>
                <option selected="selected" value="11">特训班详情页</option>
                <option value="12">特训班回顾页</option>
            <{/if}>
            <{if $data['relevanceType'] eq 12 && in_array($positionType,[12,21])}>
...
<script>
    ...
    function changePrice(){
        $.ajax({
            type:"GET",
            url:'/InstitutesRecommend/queryPrice?id='+"<{$data['relevanceId']}>",
            async: false,
            beforeSend:function(){
            },
            error: function(request) {
