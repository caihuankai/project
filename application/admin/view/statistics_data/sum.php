...
<script type="text/javascript">
    ...
    function initTable() {
        ...
        $table.bootstrapTable({
            ...
            columns: [
            {
                ...
                field: 'inpour_consumpt',
                title: '充值金额（元）'
            },{
                field: 'course',
                title: '购买课程（次）'
            },{
                field: 'course_consumpt',
                title: '课程消费（元）'
            },{
                field: 'viewpoint',
                title: '购买观点（次）'
            },{
                field: 'viewpoint_consumpt',
                title: '观点消费（元）'
            }, {
                field: 'admire',
                title: 'Live直播送礼（次）'
            }, {
                field: 'admire_consumpt',
                title: 'Live直播送礼消费（元）'
            }, ],
    ...
    function exportExcel(){
        ...
        var url = '/StatisticsData/sumExportExcel?logmin='+logmin+'&logmax='+logmax;
