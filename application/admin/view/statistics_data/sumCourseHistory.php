...
<div class="form-inline" align="center">
    <div id="toolbar" class="btn-group">
        <a class="btn" style="margin-right:10px;"><{$courseName}></a>
    ...
    <div class="form-group">
        ...
        <input type="text" placeholder="昵称" id="alias" class="form-control input-text Wdate" name="create_time_min">
...
<script type="text/javascript">
    ...
    function exportExcel(){
        ...
        var url = '/StatisticsData/sumCourseHistoryExcel?logmin='+logmin+'&logmax='+logmax+'&liveId='+liveId+'&alias='+alias+'&type='+type;
