...
<script type="text/javascript">
    ...
    function initTable() {
        ...
        $table.bootstrapTable({
            ...
            columns: [
            {
                ...
                field: 'subscribe_total',
                title: '日新增用户数'
            },{
                field: 'unsubscribe_total',
                title: '日用户流失量'
            },{
                field: 'unsubscribe_ratio',
                title: '日用户流失率'
            },{
                field: 'live_total',
                title: '日公共直播间在线人数'
    ...
    function exportExcel(){
        ...
        var url = '/StatisticsData/sumDataExportExcel?logmin='+logmin+'&logmax='+logmax;
        layer.confirm('导出用户统计表格到本地',function(index){
            window.open(url);  
        });
    }
