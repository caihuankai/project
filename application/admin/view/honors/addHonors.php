...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid" placeholder="" name="name" value="" id="name">
            <br>
        </div>
    </div>
    ...
    <input type="hidden" class="input-text valid" placeholder="" name="imgurl" value="" id="imgurl">
