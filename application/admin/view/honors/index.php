...
<div class="form-inline" align="center">
    ...
    <button onclick="honor_add()" type="button" class="btn btn-success" style="margin-right:10px;">　新增　</button>  
  </div>
  <!--工具按钮结束-->
...
<script type="text/javascript">
    $table = $('#userListTable');
    var addUrl = '/Honors/addHonors';
    var g_delarray = '/Honors/delHonors';
    var g_editUrl = '/Honors/editHonors';
    var url = '#';
    ...
    //删除单条推荐
    function honor_del(id){
        layer.confirm('确认要删除该资质吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/Honors/delHonors?id='+id,
                dataType: 'json',
