...
<script type="text/javascript">
    ...
    var addUrl = "<{:url('/Slideshow/add/positionType/')}>"+ positionType;
    var g_delarray = "<{:url('/Slideshow/del_array')}>";
    var g_editUrl = "<{:url('/Slideshow/edit')}>";
    var url = '#';
    var g_windowHight = '510';
    var g_start_array = "<{:url('/Slideshow/start_array')}>";
    var g_stop_array = "<{:url('/Slideshow/stop_array')}>";
    $(function () {
        $('#time').datetimepicker({
