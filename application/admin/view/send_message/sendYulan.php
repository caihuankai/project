...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
		...
		<input type="hidden" class="input-text valid" placeholder="" name="id" value="<{$id}>" id="id">

        <div class="row cl">
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请填写您在大策略平台上的用户ID" id="user_id" name="user_id" maxlength="20" style="width:450px;">
            </div>
        </div>
		</br></br>
        <div class="row cl">
