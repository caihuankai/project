...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid" placeholder="" autoComplete="Off" name="columnName" value="<{$data['name']??''}>" id="column-name">
        </div>
    </div>
    
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3">图片封面：</label>
        <div class="formControls col-xs-8 col-sm-9">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <img src="<{$data['qiniuImg']??''}>" id="showImage" name="showImage" alt="" height="200" width="200">
            <br>
        </div>
    </div>
    <br>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <textarea class="textarea radius" id="lead"><{$data['lead']??''}></textarea>
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid input-short" placeholder="" autoComplete="Off" name="virtualReadNum" value="<{$data['virtual_read_num']??'0'}>" id="virtual-read-num">
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid input-short" placeholder="" autoComplete="Off" name="virtualFocusNum" value="<{$data['virtual_focus_num']??'0'}>" id="virtual-focus-num">
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8">
            <div class="radio-box">
                <input type="radio" id="level" name="level" value="0" <{eq name="data.level" value="0"}>checked<{/eq}> >
                <label for="level">免费</label>
            </div>
            <div class="radio-box">
                <input type="radio" id="level" name="level" value="1" <{eq name="data.level" value="1"}>checked<{/eq}> >
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid input-short" placeholder="" autoComplete="Off" name="price" value="<{$data['price']??''}>" id="price">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <table id="cycle-price-info">
            	...
            	<tbody>
            		<{volist name="$data['cycle_price_info']" id="cyclePrice"}>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8">
            <div class="radio-box">
                <input name="status" type="radio" id="status" value="1" <{eq name="data.status" value="1"}>checked<{/eq}> >
                <label for="status">启用</label>
            </div>
            <div class="radio-box">
                <input type="radio" id="status" name="status" value="2" <{eq name="data.status" value="2"}>checked<{/eq}> >
