    ...
    <form class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="职位名称" required="required" id="position_name" name="position_name" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>职位类别：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="职位类别" required="required" id="posttion_category" name="posttion_category" maxlength="30">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" required="required" required="required" placeholder="工作地点" id="address" name="address" maxlength="80">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>工作年限：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="工作年限" required="required" id="working_years" name="working_years" maxlength="20">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>招聘人数：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="招聘人数" required="required" id="recruitment_num" name="recruitment_num" maxlength="4">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>工作类别：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="工作类别" required="required" id="working_category" name="working_category" maxlength="30">
            </div>
        </div>
        <div class="row cl">
