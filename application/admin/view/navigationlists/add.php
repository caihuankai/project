    ...
    <form class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="" id="navigation_name" name="navigation_name" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>图标：</label>
<!--            <div class="formControls col-xs-4 col-sm-2">-->
<!--                <img src="" id="showimg"style="width: 100px;height: 100px;border: 0 solid #000">-->
<!--            </div>-->
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text"  value="" placeholder="" id="showimgpath">
            </div>
            <div class="formControls col-xs-4 col-sm-2">
                <a class="upload">选择文件
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="" id="target_id" name="target_id" maxlength="255">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>排序：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input type="text" class="input-text" value="" placeholder="" id="sort" name="sort" maxlength="8">
            </div>
        </div>
        <div class="row cl">
