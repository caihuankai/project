...
<script>
    $table = $('#userListTable');
    var addUrl = '/Navigationlists/add/navigationId/<{$navigationId}>';
    var editUrl = '/Navigationlists/edit';
    ...
    function _editstatus(id,status) {
        layer.confirm('确认改变该导航当前状态？',function(index){
            $.ajax({
                type: 'POST',
                url: "/Navigationlists/editstatus",
                data:{
                    id:id,
                    status:status,
                },// 参数
