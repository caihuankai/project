...
<script type="text/javascript">
    $table = $('#userListTable');
    var addUrl = '/WebFocusMap/addRecomment/positionType/<{$positionType}>';
    var g_delarray = '/WebFocusMap/del_array';
    var g_editUrl = '/WebFocusMap/editRecomment';
    var url = '#';
    var g_windowHight = '510';
    var g_start_array = '/WebFocusMap/recomment_start_array';
    var g_stop_array = '/WebFocusMap/recomment_stop_array';
    ...
    function recomment_del(id){
        layer.confirm('确认要删除该推荐吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/WebFocusMap/recomment_del?id='+id,
                dataType: 'json',
    ...
    function recomment_stop(id){
        layer.confirm('确认要停用该推荐吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/WebFocusMap/recomment_stop?id='+id,
                dataType: 'json',
                success: function(data){
                    if (data.status == 1) {
                        layer.msg('停用成功');
    ...
    function recomment_start(id){
        layer.confirm('确认要启用该推荐吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/WebFocusMap/recomment_start?id='+id,
                dataType: 'json',
                success: function(data){
                    if (data.status == 1) {
                        layer.msg('启用成功');
