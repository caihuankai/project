...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <select name="data_type" id="data_type" class="form-control form-select" >
            <{if $data['relevanceType'] eq 3}>
                <option value="7">外链</option>
                <option value="4">课程介绍页</option>
                <option value="6">讲师介绍页</option>
                <option value="5">观点详情页</option>
                <option selected="selected" value="3">Live直播间</option>
            <{/if}>
            <{if $data['relevanceType'] eq 4}>
                <option value="7">外链</option>
                <option selected="selected" value="4">课程介绍页</option>
                <option value="6">讲师介绍页</option>
                <option value="5">观点详情页</option>
                <option value="3">Live直播间</option>
            <{/if}>
            <{if $data['relevanceType'] eq 5}>
                <option value="7">外链</option>
                <option value="4">课程介绍页</option>
                <option value="6">讲师介绍页</option>
                <option selected="selected" value="5">观点详情页</option>
                <option value="3">Live直播间</option>
            <{/if}>
            <{if $data['relevanceType'] eq 6}>
                <option value="7">外链</option>
                <option value="4">课程介绍页</option>
