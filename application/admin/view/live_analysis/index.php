...
<div class="form-inline" align="center">
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">Live直播间概况</li>
            <li>Live直播间效果</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show layui-anim layui-anim-scale">
                <div class="layui-elem-quote layui-row">
                    <div class="layui-col-md4">
                        <h3 style="padding-top: 0.5rem;">Live直播间概况</h3>
                    </div>
            ...
            <div class="layui-tab-item layui-anim layui-anim-scale">
                <div class="layui-elem-quote layui-row">
                    <div class="layui-col-md4">
                        <h3 class="layui-col-md6" style="padding-top: 0.5rem;">Live直播间概况</h3>
                ...
                <form class="layui-form" action="">
                    <div id="table-search-html" class="text-c">
                        <input type="text" class="input-text" placeholder="讲师昵称"  name="teacherName"/>
                        <input type="text" onfocus="WdatePicker({maxDate:'#F{\$dp.\$D(\'search-dateMax\')||\'%y-%M-%d\'}'})" name="dateMin" id="search-dateMin" placeholder="开始时间"
                               class="input-text Wdate">-
                        <input type="text" onfocus="WdatePicker({minDate:'#F{\$dp.\$D(\'search-dateMin\')}',maxDate:'%y-%M-%d'})" name="dateMax" id="search-dateMax" placeholder="结束时间"
                               class="input-text Wdate">
...
<script>
    layui.use(['layer', 'form','table','element'], function(){
        //element选项卡切换,折叠事件
        var form = layui.form,table = layui.table,ListTableWhere= $("select#tableData").val(),tableDataWhere= $("select#tableData").val(),element = layui.element;
        ...
        table.render({
            ...
            ,cols: [[ //表头
                {field: 'info',colspan:2, title: 'Live直播间信息',align:'center'}
                ,{field: 'date', title: '日期',rowspan:2}
                ,{field: 'id', title: 'Live直播间ID',rowspan:2}
                ,{field: 'visitors_nun', title: '访客数',rowspan:2,sort: true}
                ,{field: 'browse_nun', title: '浏览量',rowspan:2, sort: true}
                ,{field: 'percapita_time_len',rowspan:2, title: '人均停留时长（秒）',sort: true}
                ,{field: 'gift_amount_nun',rowspan:2, title: '总送礼金额',sort: true}
                ,{field: 'online_nun',rowspan:2, title: '真实总在线人数'}
            ],[
                {field: 'head_add', title: '',templet: function(data){
                        return "<img onclick='_showBig(\""+data.head_add+"\")' src="+ data.head_add +"  style='width:auto;height:100%'/>"
                    }}
                ,{field: 'alias', title: ''}
            ]]
            ,id: 'ListTable'
    ...
    function exportExcel(){
        ...
        console.log(ListTableWhere);
        var url = '/LiveAnalysis/dataExportExcel?optionData='+ ListTableWhere;
