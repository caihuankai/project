...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3">微信账号id：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid" placeholder="" name="wechatId" value="" id="wechatId">
            <br>
        </div>
    </div>
    ...
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3">微信二维码（图片不能大于3M）：</label>
        <div class="formControls col-xs-8 col-sm-9">
    ...
    <input type="hidden" class="input-text valid" placeholder="" name="qrcodeUrl" value="" id="qrcodeUrl">
