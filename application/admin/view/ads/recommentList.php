...
<script type="text/javascript">
    $table = $('#userListTable');
    var addUrl = '/Ads/addRecomment/positionType/<{$positionType}>';
    var g_delarray = '/Ads/del_array';
    var g_editUrl = '/Ads/editRecomment';
    var url = '#';
    var g_windowHight = '510';
    var g_start_array = '/Ads/recomment_start_array';
    var g_stop_array = '/Ads/recomment_stop_array';
