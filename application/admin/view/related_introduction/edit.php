    ...
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-2">
                <img src="<{$info.icon}>" id="showimg"style="width: 60px;height: 60px;border: 0 solid #000">
            </div>
            <div class="formControls col-xs-4 col-sm-2">
                <a class="upload">上传
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-2">
                <img src="<{$info.qr_code}>" id="showimg2"style="width: 60px;height: 60px;border: 0 solid #000">
            </div>
            <div class="formControls col-xs-4 col-sm-2">
                <a class="upload">上传
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-3 col-xs-offset-3 col-sm-offset-3">
                <input class="btn btn-primary radius" style="margin: auto" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
            </div>
