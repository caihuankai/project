...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <video id="admin-qi-niu-upload-div-be-upload-del-1-video" src="<{$data['remark']}>" width="150px" height="100px" preload="meta" controls="controls" 0="" class=""></video>
        <span>
        <span id="admin-qi-niu-upload-div-be-upload-del-1-upload-button" class="btn btn-primary upload-btn" style="width:100px"><i class="Hui-iconfont">&#xe642;</i>浏览文件</span>
        </span>
    ...
    <input type="hidden" class="input-text valid" placeholder="" name="videoUrl" value="<{$data['remark']}>" id="videoUrl">
