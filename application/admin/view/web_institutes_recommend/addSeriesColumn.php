...
<div class="form-inline" align="center">
  ...
  <!--工具按钮结束-->
    <div class="form-group">
        <!-- <input type="text" class="form-control input-text" placeholder="ID" id="name" name="name">
        <input type="text" class="form-control input-text" placeholder="创建人" id="name" name="name">
        <input type="text" class="form-control input-text" placeholder="课程名称" id="name" name="name">
        <span>
...
<script type="text/javascript">
    $table = $('#userListTable');
    var g_editUrl = '/WebInstitutesRecommend/editSeriesColumn';
    var url = '#';
