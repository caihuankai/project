...
<div class="form-inline" align="center">
    ...
    <button onclick="recomment_add()" type="button" class="btn btn-success" style="margin-right:10px;">　新增　</button>     
...
<script type="text/javascript">
    $table = $('#userListTable');
    var addUrl = '/WebInstitutesRecommend/addSeriesColumn/positionType/<{$positionType}>';
    var g_delarray = '/WebInstitutesRecommend/del_array';
    var g_editUrl = '/WebInstitutesRecommend/editRecomment';
    var url = '#';
    var g_windowHight = '510';
    var g_start_array = '/WebInstitutesRecommend/recomment_start_array';
    var g_stop_array = '/WebInstitutesRecommend/recomment_stop_array';
    ...
    function recomment_del(id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/WebInstitutesRecommend/recomment_del?id='+id,
                dataType: 'json',
    ...
    function recomment_stop(id){
        layer.confirm('确认要停用吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/WebInstitutesRecommend/recomment_stop?id='+id,
                dataType: 'json',
                success: function(data){
                    if (data.status == 1) {
                        layer.msg('停用成功');
    ...
    function recomment_start(id){
        layer.confirm('确认要启用吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '/WebInstitutesRecommend/recomment_start?id='+id,
                dataType: 'json',
                success: function(data){
                    if (data.status == 1) {
                        layer.msg('启用成功');
