...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
     ...
     <input type="hidden" class="input-text valid" placeholder="" name="videoUrl" value="" id="videoUrl">
    ...
    <div class="row cl">
        ...
        <video id="admin-qi-niu-upload-div-be-upload-del-1-video" src="" width="150px" height="100px" preload="meta" controls="controls" 0="" class="hide-ele"></video>
        <span>
