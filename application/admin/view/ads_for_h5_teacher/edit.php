...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <select name="relevanceType" id="relevanceType" class="form-control form-select" >
            <option value="14" <{eq name="data.relevanceType" value="14"}>selected<{/eq}> >讲师介绍页</option>
            <option value="15" <{eq name="data.relevanceType" value="15"}>selected<{/eq}> >月度课介绍页</option>
            <option value="16" <{eq name="data.relevanceType" value="16"}>selected<{/eq}> >季度课介绍页</option>
            <option value="17" <{eq name="data.relevanceType" value="17"}>selected<{/eq}> >私人订制课页面</option>
        </select>
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid" name="relevanceId" value="<{$data['relevanceId']??''}>" id="relevanceId" placeholder="请输入跳转类型的ID（如跳转类型为链接，请输入链接地址）">
            <br>
            <small></small>
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <select name="adStatus" id="adStatus" class="form-control form-select" >
            <option value="1" <{eq name="data.adStatus" value="1"}>selected<{/eq}> >启用</option>
            <option value="-1" <{eq name="data.adStatus" value="-1"}>selected<{/eq}> >禁用</option>
        </select>
        </div>
    </div>
