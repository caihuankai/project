    ...
    <form class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" value="" placeholder="输入股票名称" id="stock_name" name="stock_name" maxlength="80">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">* </span>股票编号：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" value="" placeholder="输入股票编号" id="stock_num" name="stock_num" maxlength="80">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">* </span>涨跌幅：</label>
            <div class="formControls col-xs-4 col-sm-5">
                <input type="number" style="width: 78%" class="input-text" value="" placeholder="请输入数字，最多支持两位小数" id="pricechangeratio" name="pricechangeratio" maxlength="80">
