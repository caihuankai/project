...
<nav class="breadcrumb">
    ...
    <script>document.write("用户列表 > 用户详情")</script>
    <span class="c-gray en">&gt;</span>
    <script>document.write("付费观点包时记录")</script>
...
<div class="form-inline" align="center">
    <div class="form-group">
        ...
        <input type="text" class="form-control input-text" placeholder="被购买人" id="teachername" name="teachername">
