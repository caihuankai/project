...
<div class="form-inline" align="center">
    <div class="form-group">
        ...
        <input type="text" class="form-control input-text" placeholder="被购买人" id="usermane" name="usermane">
        <input type="text" class="form-control input-text" placeholder="观点名称" id="classname" name="classname">
