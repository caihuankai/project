...
<div class="form-inline" align="center">
    <div class="form-group">
        <input type="text" class="form-control input-text" placeholder="礼物名称" id="giftName" name="giftName">
        <input type="text" class="form-control input-text" placeholder="赠送者昵称" id="studentname" name="studentname">
        <input type="text" class="form-control input-text" placeholder="接收者昵称" id="teachername" name="teachername">
        <select name="giftType" id="giftType" class="form-control form-select" >
            <option value="">类型</option>
            <option value="1">常规礼物</option>
            <!-- <option value="2">VIP会员礼物</option> -->
        </select>
