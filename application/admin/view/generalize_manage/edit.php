    ...
    <form class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                ...
                <input type="text" class="input-text" required="required" value="<{$info.ad_group_name}>" placeholder="" id="ad_group_name" name="ad_group_name" maxlength="30">
            </div>
        </div>
        <div class="addlist">
            <div class="row cl">
                        ...
                        <div class="formControls col-xs-4 col-sm-4">
                            <select id="affiliation_column" name="affiliation_column">
                                <{volist name="column" id="vo"}>
                                    <{if condition="$info.affiliation_column == $vo.id"}>
                        ...
                        <div class="formControls col-xs-8 col-sm-8">
                            <div class="row" style="margin-top: 0;">
                                ...
                                <div class="formControls col-xs-3 col-sm-3">
                                    <input type="number" required="required" style="height:25px;padding:0;width: 100%;" class="input-text" value="<{$info.column_place}>" placeholder="" id="column_place" name="column_place" maxlength="3">
                                </div>
...
<!--        </div>-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                <input required="required" type="text" class="input-text" value="<{$info.ad_title1}>" placeholder="" id="title1" name="title1" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            ...
            <img src="<{$info.ad_img1}>" id="showimg1" style="width: 80px;height: 80px;">（图片不能大于1024KB）
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-3 col-sm-4">
                <select id="ad_target_type1" name="ad_target_type1">
                    <{volist name="type" id="vo"}>
                        <{if condition="($info.ad_target_type1 == $vo.type) AND ($info.ad_target_type_name1 == $vo.name)"}>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-6">
                <input required="required" type="text" class="input-text" value="<{$info.ad_target_id1 != 0 ? $info.ad_target_id1:$info.ad_target_url1}>" placeholder="" id="ad_target_id1" name="ad_target_id1" maxlength="255">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>标题：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input required="required" type="text" class="input-text" value="<{$info.ad_title2}>" placeholder="" id="title2" name="title2" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>封面图：</label>
            ...
            <img src="<{$info.ad_img2}>" id="showimg2" style="width: 80px;height: 80px;">（图片不能大于1024KB）
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>跳转类型：</label>
            <div class="formControls col-xs-3 col-sm-4">
                <select id="ad_target_type2" name="ad_target_type2">
                    <{volist name="type" id="vo"}>
                        <{if condition="($info.ad_target_type2 == $vo.type) AND ($info.ad_target_type_name2 == $vo.name)"}>
                            <option selected="selected" value="<{$vo.type}>"><{$vo.name}></option>
                        <{else /}>
                            <option value="<{$vo.type}>"><{$vo.name}></option>
                        <{/if}>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>ID/链接：</label>
            <div class="formControls col-xs-4 col-sm-6">
                <input required="required" type="text" class="input-text" value="<{$info.ad_target_id2 != 0 ? $info.ad_target_id2:$info.ad_target_url2}>" placeholder="" id="ad_target_id2" name="ad_target_id2" maxlength="255">
            </div>
        </div>
        <div class="row cl">
