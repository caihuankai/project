<!--<article>
	<form action="" method="post" class="form form-horizontal" id="form-group-add" style="width: 770px;padding: 0px 15px;">
		<div class="row cl">
...
<article>
  <form action="" method="post" class="form form-horizontal" id="form-group-add" style="padding: 15px 15px 0;max-width:500px;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="75%"><input type="text" class="input-text" value="" placeholder="" id="name" name="name"></td>
      </tr>
      <tr>
	...
	$("#form-group-add").validate({
		...
		submitHandler:function(form){
			...
			$.ajax({
				type:"POST",
				url:url,
				data:$('#form-group-add').serializeArray(),// 你的formid
				async: false,
				beforeSend:function(){
