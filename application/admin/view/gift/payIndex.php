...
//                原需求：按范围显示
//                if(rows.money_max <= 100){
//                    return '0.00-100.00';
//                }else if(100 < rows.money_max && rows.money_max <= 1000){
//                    return '100.01-1000.00';
//                }else if(1000 < rows.money_max && rows.money_max <= 3000){
//                    return '1000.01-3000.00';
//                }else if(3000 < rows.money_max && rows.money_max <= 5000){
//                    return '3000.01-5000.00';
//                }else if(5000 < rows.money_max && rows.money_max <= 8000){
//                    return '5000.01-8000.00';
//                } else if(rows.money_max >= 8000){
//                    return rows.money_max + '以上';
//                }
//                新需求
                return val + '-' + rows.money_max;
            }
	}, {
            field: 'type',
            title: '类型',
