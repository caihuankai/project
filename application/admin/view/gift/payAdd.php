...
<article class="page-container">
    <form class="form form-horizontal" id="form-category-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>礼点范围：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text col-sm-2" value="<{:getArrVal($gift_data, 'money', '')}>" placeholder="0.00" name="money">
                <span class="col-sm-1" style="line-height: 28px;">—</span>
                <input type="text" class="input-text col-sm-2" value="<{:getArrVal($gift_data, 'money_max', '')}>" placeholder="0.00" name="money_max">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <span style="position: absolute;top: 8px;right: 62px;">（图片类型：GIF/PNG/JPG，大小：1M以下，尺寸：500*500）</span>
