        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.msg == 200){
                    ...
                    $("#uname").html(data.data.alias+'<input type="hidden"  value='+data.data.alias+' id="alias" name="alias">');
                    $("#utype").html(data.data.user_type+'<input type="hidden"  value='+data.data.user_type+' id="user_type" name="user_type">');
                }else{
