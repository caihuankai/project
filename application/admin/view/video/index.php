...
<div id="table-search-html">
    ...
    <input type="text" class="input-text" placeholder="所属老师" id="search-user-name" name="userName"/>
    <{date_range title="添加"}>
...
<script>
    ...
    window['adminTableConfig'] = {
        onLoadSuccess: function (){
            ...
            $('.open-status').click(function (){
				...
				var localSuccess = function(){
                    layer.msg('修改成功');
                    e.parents('tr').children('td').eq(5).html(columnStatusHtml[status]);
            ...
            $('.action-edit').click(function (){
                ...
                layer_show('编辑', '<{:url("edit")}>' + '?id=' + e.data('id'), 800, 500);
            });
    ...
    $(function () {
        ...
        $('#table-button-del').click(function () {
            ...
            ids.length > 0 && deleteVideo(ids, option);
        });
        ...
        $('#table-button-dis, #table-button-open').click(function () {
        	...
        	var localSuccess = function(){
        		layer.msg('修改成功');
        		for (key in ids){
        			$('.open-status[data-id=' + ids[key] +']').parents('tr').children('td').eq(5).html(columnStatusHtml[status]);
        ...
        $('#table-button-add').click(function (){
            ...
            layer_show('新增', '<{:url("add")}>', 800, 500);
        });
        
    });

    function deleteVideo(ids, option){
        requestAjax({
            ids: ids,
        }, option);
    }
