...
<form class="form form-horizontal" id="form-admin-edit">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid" placeholder="" autoComplete="Off" name="title" value="<{$videoInfo['title']??''}>" id="title">
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <img src="<{$videoInfo['cover_pc_url']??'http://oqt46pvmm.bkt.clouddn.com/Ft56ta8EDC03VFYIHzFuSjcv5E5_'}>" id="showimg" style="width: 60px;height: 60px;border: 0 solid #000">
            <a class="upload">上传
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text valid" placeholder="填写老师ID" autoComplete="Off" name="userId" value="<{$videoInfo['uid']??''}>" id="userId">
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
        	<?php echo \qiNiu\QiNiuHtml::instance()->getVideoHtml($videoInfo['video_url'])?>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8">
            <div class="radio-box">
                <input name="status" type="radio" id="status" value="1" <{eq name="videoInfo.open_status" value="1"}>checked<{/eq}> >
                <label for="status">启用</label>
            </div>
            <div class="radio-box">
                <input type="radio" id="status" name="status" value="2" <{eq name="videoInfo.open_status" value="2"}>checked<{/eq}> >
        ...
        $("#form-admin-edit").validate({
            ...
            submitHandler:function(form){
            	...
            	$(form).ajaxSubmit({
            		type:"POST",
            		url:"./edit",
            		data:{id:<{$videoInfo['id']}>,coverPC:coverPC, video:video},
            		beforeSend:function(){
