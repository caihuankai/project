...
<!--      </select>-->
    ...
    <button type="submit" onclick="javascript:$('button[name=\'refresh\']').click();" class="btn btn-success radius" id="" name="">
      <i class="Hui-iconfont">&#xe665;</i>搜用户</button></div>
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    <div id="toolbar" class="btn-group">   
      <button id="btn_add" type="button" class="btn btn-success">　新增会员　</button> &nbsp;
      <button disabled id="btn_delete" type="button" class="btn btn-danger" title="请先选中要删除的菜单">　删除　</button></div>
    <div class="mt-20">
...
<script type="text/javascript">
    ...
    function member_edit(id) {
        layer_show('编辑用户', g_editUrl + '?userId=' + id, '', g_windowHight);
    }
