...
<div class="text-c" id="table-search">
    <form class="form form-horizontal" id="form-search" action="/CommentAudit/liveCommentDetail" method="post">
        ...
        <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="text-decoration: none;">
                <div>
                    ...
                    <a onclick="actionType(<?=$master['id']?>, 'changeStatus', <?=$master['state']?>, 1, 1)"><{if condition="$master.state == 1"}><span style="color: red">屏蔽</span><{else /}>显示<{/if}></a>
        ...
        <div class="panel-body">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                <div>
                    ...
                    <a onclick="actionType(<?=$v['id']?>, 'changeStatus', <?=$v['state']?>, 1, 2)"><{if condition="$v.state == 1"}><span style="color: red">屏蔽</span><{else /}>显示<{/if}></a>
