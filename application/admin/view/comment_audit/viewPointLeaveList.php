...
<div id="table-search-html">
    <input type="text" class="input-text" placeholder="观点名称" id="search-viewpointname" name="search-viewpointname"/>
    <input type="text" class="input-text" placeholder="留言内容" id="search-content" name="search-content"/>
    <input type="text" class="input-text" placeholder="留言人" id="search-contentuser" name="search-contentuser"/>
...
<script>
    ...
    function loadClick(){
        ...
        $('.reply-html').click(function () {
            var e = $(this),
                ...
                uid = e.data('uid');
            layer_show('回复', '<{:url("CommentAudit/replyLeave")}>' + '?pid=' + pid + '&groupid=' + groupid + '&uid=' + uid, 600, 400);
    ...
    window['adminTableQueryParams'] = function (){
        return {
            title: $('#search-viewpointname').val(),
