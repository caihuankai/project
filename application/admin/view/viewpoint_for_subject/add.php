...
<form class="form form-horizontal" id="form-admin-add">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-10 col-sm-11">
        	<input type="text" id="select-start-time" name="startTime" placeholder="年月日" value="" class="input-text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd 00:00:00', maxDate:'#F{\$dp.\$D(\'select-end-time\')}'})" readonly style="width:170px;">
        	
        	-
        	<input type="text" id="select-end-time" name="endTime" placeholder="年月日" value="" class="input-text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd 23:59:59', minDate:'#F{\$dp.\$D(\'select-start-time\')}'})" readonly style="width:170px;">
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-10 col-sm-11">
            <input type="text" class="input-text valid" placeholder="" autoComplete="Off" name="lead" value="" id="lead">
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-10 col-sm-11">
            <input type="text" class="input-text valid input-short" placeholder="" autoComplete="Off" name="author" value="大策略" id="author">
        </div>
    </div>
