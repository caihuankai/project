...
<div class="form-inline" align="center">
    <div class="form-group">
        ...
        <input type="text" class="form-control input-text" placeholder="作者" id="teachername" name="teachername">
        <input type="text" class="form-control input-text" placeholder="购买人" id="username" name="username">
        <input type="text" class="form-control input-text" placeholder="支付金额" id="amount" name="amount">
        <select name="paytype" id="paytype" class="form-control form-select" >
            <option value="">支付方式</option>
            <option value="2">微信支付</option>
            <option value="3">连连支付</option>
        </select>
        <select name="coursetype" id="coursetype" class="form-control form-select" >
            <option value="">课程类型</option>
            <option value="1">月度课</option>
            <option value="2">季度课</option>
        </select>
        <input type="text" placeholder="购买时间段" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'logmax\')||\'%y-%M-%d\'}' })" id="logmin" class="form-control input-text Wdate" name="create_time_min">
        -
        <input type="text" placeholder="购买时间段" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'logmin\')}',maxDate:'%y-%M-%d' })" id="logmax" class="form-control input-text Wdate" name="create_time_max">
        ...
        $table.bootstrapTable({
            ...
            queryParams: function queryParams(params) {   //设置查询参数
                var param = {
                    ...
                    coursetype: $.trim($('#coursetype').val()),
                };
                return param;
            },
