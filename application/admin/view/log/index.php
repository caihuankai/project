...
<div class="page-container">
    <div class="text-c">
        <input type="text" class="input-text" style="width:250px" placeholder="输入管理员名" id="manager" name="manager">
        <button type="submit" onclick="javascript:$('button[name=\'refresh\']').click();" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 按管理员搜索
        </button>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <div id="toolbar" class="btn-group">              
                     &nbsp;
            <button disabled id="btn_delete" type="button" class="btn btn-danger" title="请先选中要删除的行">
                    删除                   
            </button>
               &nbsp;
        </div>
        ...
        $table.bootstrapTable({
            ...
            columns: [{
                ...
                formatter:function(value,row,index){
                    if(value == 0){
                        return '<font class="hint-green">成功</font>';
                    }else{
                        return '<font class="hint-red">失败</font>';
                    }
                },
                title: '状态',
								align:'center'
