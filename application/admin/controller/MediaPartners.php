...
class MediaPartners extends App
{
    ...
    public function index()
    {
        ...
        return $this->traitAdminTableList(function (){
            ...
            $data = $this->traitAdminTableQuery([], function () use ($model) {
                $model->alias('e')->where('e.type','=',1);
                return $model;
            }, $field, 'e.create_time desc');
            ...
            foreach ($data['rows'] as $k => $datum) {
                ...
                $result[] = [
                    ...
                    'path_url' => '<img src='."{$img}".' style="width: 80px;height: 80px;">',
                    'logo_url' => $datum['path_url'],
                    'url' => $datum['url'],
                    'action' => $action,
                ];
            }
