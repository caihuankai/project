...
class College extends App{
	...
	public function getBanner($type,$page=1,$limit=100){
		...
		$where['a.relevanceType'] = ['in',[4,9,10,11,12]];
		$where['c.form'] = ['in',[1,2]];
		$dataList = $AdsM->alias('a')
		->join('talk.talk_course c','c.id = a.relevanceId')
		->field('a.adId as id,a.adFile as imgUrl,a.adName as title,a.relevanceType,a.relevanceId')
	...
	/**
	 * 99学院各种课程列表页
	 * @param  [type]  $type  10：99学院首页-最新，11：99学院首页-五分钟解盘，12：99学院首页-热门学习，13：99学院首页-本周热销，15：专题课列表-专题研究，16：专题课列表-回顾，18：系列课列表-推荐，21：特训班列表-最新，22：特训班列表-回顾',
