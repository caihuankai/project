    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: actionUrl,
               fileVal: editor.getOpt('imageNewFieldName'),
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.status == '1') {
						json.url = editor.getOpt('imagRootUrl')+json.path+"?thum="+json.thum+"&thumWidth="+json.thumWidth+"&thumHeight="+json.thumHeight+
                        "&path="+json.path+"&with="+json.with+"&high="+json.high;
