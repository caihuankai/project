...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return (item.id != _vm.courseId) ? _c('router-link', {
      key: item.id,
      staticClass: "item",
      attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-73b7ab5c", module.exports)
  }
}
...
var update = __webpack_require__(29)("b5b9a880", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-73b7ab5c\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./onliveSendLink.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-73b7ab5c\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./onliveSendLink.vue");
...
Component.options.__file = "F:\\SVN\\webApp\\公众号\\dacelve1.0\\src\\personalCenter\\onliveSendLink.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] onliveSendLink.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-73b7ab5c", Component.options)
  } else {
    hotAPI.reload("data-v-73b7ab5c", Component.options)
  }
...
exports.default = {
    ...
    created: function created() {
        ...
        this.$store.commit('setTitle', '发送链接');
        this.$store.dispatch('getUserInfo', function (res) {
            if (_this.userId != _this.$route.params.id) {
                //                this.$router.replace('/onlive/' + this.userId + '&' + this.userId);
                _this.$route.go(-1);
            }
        });
        this.getCourseList();
    ...
    methods: {
        ...
        sendCourse: function sendCourse(id) {
            ...
            //发送课程到课程直播间
            this.$http.get('/LiveDetails/sendCourse', { params: { senderId: this.userId, courseId: id, receiverType: 2, receiverId: this.courseId } }).then(function (res) {
                ...
                if (res.body.code == 0) {
                    ...
                    setTimeout(function () {
                        //		                this.$router.push('/onlive/' + this.courseId);
                        _this3.$router.go(-1);
                    }, 1600);
                }
            });
        ...
        sendView: function sendView(id) {
            ...
            //发送观点到课程直播间
            this.$http.get('/Viewpoint/sendViewpointToLive', { params: { viewpointId: id, receiverType: 2, receiverId: this.courseId, senderId: this.userId } }).then(function (res) {
        ...
        getViewList: function getViewList(flag) {
            ...
            if (flag === true) {
                ...
                this.getLiveViewList(this.$route.params.id, this.viewPage, function (res) {
                    console.log(res);
                    _this5.viewList = _this5.viewList.concat(res.data.viewpointList);
                    _this5.courseLoading = false;
                    if (res.data.viewpointList && res.data.viewpointList.length < 15) {
                        _this5.courseEnd = true;
                    }
                }, '1');
            } else {
                this.getLiveViewList(this.$route.params.id, this.viewPage, function (res) {
