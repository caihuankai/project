...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('main', {
  ...
  }, [_c('span', [_vm._v("互动")])]), _vm._v(" "), _c('li', {
    staticClass: "btn",
    class: {
      active: _vm.tabShowM == 1
    },
    on: {
      "click": function($event) {
        _vm.tabShowM = 1
  ...
  }, [_c('span', [_vm._v("介绍")])]), _vm._v(" "), _c('li', {
    staticClass: "btn ",
    class: {
      active: _vm.tabShowM == 2
    },
    on: {
      "click": function($event) {
        _vm.tabShowM = 2
  ...
  }, [_c('span', [_vm._v("课程安排")])])])]), _vm._v(" "), _c('section', {
    staticClass: "box-center"
  }, [_c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.tabShowM == 0),
      expression: "tabShowM == 0"
    }]
  }, [
    [_c('div', {
      ref: "topHeader",
      ...
      staticClass: "hot-num"
    }, [_vm._v(_vm._s(_vm.onliveData.focus_num || 0))]), _vm._v(" "), _c('span', [_vm._v("在线人数:")]), _c('span', {
      staticClass: "like-num"
    }, [_vm._v(_vm._s(_vm.studentNum || 0))])])])]), _vm._v(" "), (_vm.onliveData.teacher_id != _vm.userId) ? _c('a', {
      class: [_vm.onliveData.LiveFocus == 1 ? 'following' : 'unfollow', 'follow'],
      attrs: {
        "href": "javascript:;"
      },
      on: {
    ...
    }, [_vm._v("\n                                " + _vm._s(_vm.onliveData.LiveFocus == 1 ? '已关注' : '关注') + " ")]) : _vm._e()], 1), _vm._v(" "), _c('div', {
      ...
      return _c('div', {
        ...
        staticClass: "money"
      }, [_vm._v(_vm._s(JSON.parse(item.content).gifname))]), _vm._v(" "), _c('span', [_vm._v("X" + _vm._s(JSON.parse(item.content).gifcount))])])])] : (item.type == 2 || item.type == 0) ? [_c('section', [_c('h5', [_c('span', {
        staticClass: "name",
        class: {
          yellow: _vm.teacherData.user_id == item.userId
        }
      }, [_vm._v(_vm._s(item.name))]), _vm._v(" "), (_vm.teacherData.user_id == item.userId) ? _c('span', {
        staticClass: "teacher"
      ...
      })] : [_c('p', [_vm._v(_vm._s(item.content))])]], 2)])] : _vm._e()], 2)
    }), _vm._v(" "), _c('div', {
      ref: "mask",
      ...
      staticClass: "txt"
    }, [_vm._v("以上观点仅供参考，不构成投资建议")])], 2)], 1)]), _vm._v(" "), _c('footer', {
      attrs: {
        "id": "footer"
      }
    }, [_c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.tabShowM == 1),
      expression: "tabShowM==1"
    }],
    staticClass: "brief"
  }, [(_vm.CourseInfo.brief != '') ? [_c('div', {
    domProps: {
      "innerHTML": _vm._s(_vm.CourseInfo.brief)
    }
  })] : [_c('div', {
    staticClass: "noBrief"
  }, [_c('p', [_vm._v("哦~没有内容呢！")])])]], 2), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.tabShowM == 2),
      expression: "tabShowM == 2"
    }],
    staticClass: "timetable"
  }, [(_vm.CourseInfo.review != '') ? [_c('div', {
    domProps: {
      "innerHTML": _vm._s(_vm.CourseInfo.review)
    }
  })] : [_c('div', {
    staticClass: "noBrief"
  }, [_c('p', [_vm._v("哦~没有内容呢！")])])]], 2)]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-006733a2", module.exports)
  }
}
...
var update = __webpack_require__(29)("66fd73f1", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-006733a2\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./specialOnlive.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-006733a2\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./specialOnlive.vue");
...
Component.options.__file = "F:\\SVN\\webApp\\公众号\\dacelve1.0\\src\\personalCenter\\specialOnlive.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] specialOnlive.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-006733a2", Component.options)
  } else {
    hotAPI.reload("data-v-006733a2", Component.options)
  }
...
// import gift  from  "../subcomponents/live/gift.vue";
exports.default = {
    data: function data() {
        return {
            getEmojiData: [],
            studentNum: 0, //在线人数
            tabShowM: 0, //0互动  1介绍  2课程表
            isEm: true, //表情与键盘切换
            ...
            courseId: this.$route.params.id, //當前房間id this.$route.params.courseId
            rewardList: [],
            rewardLoading: true,
            rewardPage: 1,
            rewardEnd: false,
            ...
            maxL: '',
            minL: '',
            liveIsEnd: false, //是否加載到底部
            liveLoading: false, //是否加載
            isloadTops: 0, //是否為上啦加載歷史數據 0不是，1是
    ...
    created: function created() {
        ...
        this.$store.dispatch('getUserInfo', function (res) {
            ...
            _this2.getData();
            _this2.getCourseScheduleByCourseId();
            //  this.rewardClick();
            // this.getGiftBalance();
        });
    ...
    mounted: function mounted() {
        ...
        // this.loadedHandler(this.playVideo)
        //  setTimeout( () => {
    ...
    methods: {
        hideMeun: function hideMeun() {
            wx.ready(function () {
                wx.hideOptionMenu();
            });
            wx.error();
        },
        getCourseScheduleByCourseId: function getCourseScheduleByCourseId() {
            var _this3 = this;

            //获取
            this.$http.get(this.hostUrl + "/Course/getCourseList", { params: {
                    id: this.courseId,
                    field: 'brief,review'
                } }).then(function (res) {
                if (res.body.code == 200) {
                    console.log(res.body);
                    _this3.CourseInfo = res.body.data[0];
                }
            });
        },
        ...
        toFocus: function toFocus() {
            ...
            if (this.isSubscribe || this.isSubscribe == false && this.teacherData.isFocus == 1) {
                this.$http.post(this.hostUrl + '/Focus/addFocus', {
                    user_id: this.userId,
                    live_id: this.onliveData.live_id,
                    type: this.onliveData.LiveFocus == 1 ? 0 : 1
                    ...
                    if (res.body.code == 0) {
                        ...
                        _this5.onliveData.LiveFocus = _this5.onliveData.LiveFocus == 1 ? 0 : 1;
                ...
                this.$http.get(this.hostUrl + 'CreateQrCode/focus', { params: { teacherId: this.teacherData.user_id } }).then(function (res) {

                    if (res.body.code == 200) {
                        _this5.closePop = true;
                        _this5.codeImg = res.body.data;
                    } else {
        ...
        getAccountBalance: function getAccountBalance() {
            ...
            this.$http.get('/User/getAccountBalance?format=2').then(function (res) {
                if (res.body.code == 200) {
                    _this6.userLevel = res.body.data.currentVipLevel;
                }
            });
        },
        ...
        getUserInfo: function getUserInfo() {
            ...
            this.$http.get(this.hostUrl + '/User/', { params: { loginRedirectUrl: location.href } }).then(function (res) {
                if (res.body.code == 200) {
                    // 登录成功
                    _this7.$store.commit('updateUserInfo', res.body.data);
                }
            });
        },
        ...
        returnLast: function returnLast() {
            ...
            this.$refs.myPubicOnlive.scrollTo(0, this.$refs.myPubicOnlive.scroller.__maxScrollTop, true);
            // this.crollerBottom();
        ...
        loadTop: function loadTop(done) {
            ...
            if (this.liveLoading == false) {
                this.isloadTops = 1;
                setTimeout(function () {
                    _this8.getHistory(_this8.minL, false, 10, true);
                    done();
                }, 500);
                this.$refs.myPubicOnlive.finishInfinite(2);
            }
            ...
            switch (msg.subcmd) {
                ...
                case 2002:
                    ...
                    window.onbeforeunload = function () {
                        _wxfunction2.default.leaveRoom(+_this9.userId, +_this9.courseId);
                    };
                    break;
                case 2181:
                    //进入房间人数统计
                    ...
                    if (data.msg.msgType == 8) {
                        ...
                        this.comments.forEach(function (val, i) {
                            if (val.msgId === parseInt(data.msg.content)) {
                                _this9.comments.splice(i, 1);
                                console.log(_this9.comments.length);
                ...
                case 3022:
                    ...
                    if (data.msg.msgType === 8) {
                        this.comments.forEach(function (val, i) {
                            ...
                            if (i == 0) {
                                _this9.comments = [];
                                _wxfunction2.default.getTalkMsgHis(_this9.userId, _this9.courseId, 0);
                            }
                            if (val.msgId === parseInt(data.msg.content)) {
                                _this9.comments.splice(i, 1);
                                return true;
                    ...
                    if (data.msgs) {
                        ...
                        for (var i = 0, len = data.msgs.length; i < len; i++) {
                            ...
                            if (this.isloadTops == 0) {
                                //判斷是否上啦加載
                                setTimeout(function () {
                                    var mainHeight = $('.publicOnlivePage ').height() + 500;
                                    var body = $('.publicOnlive-main').height();
                                    console.log(mainHeight);
                                    _this9.$refs.myPubicOnlive.scrollTo(0, mainHeight, true);
                                    var _this = _this9;
                                    _this9.$refs.myPubicOnlive.touchEnd = function () {
                                        // touch  滑动
        ...
        getData: function getData() {
            ...
            this.$http.post(this.hostUrl + '/CourseDetails/liveing', {
                ...
                _this10.onliveData = res.body.data;
                _this10.playerOptions = _this10.onliveData.video_pic || '../images/1.9/beijingtu-ben@2x.png';
                _this10.$store.commit("setTitle", _this10.onliveData.class_name);
                var videoObject = {
                    ...
                    poster: _this10.playerOptions,
                    video: _this10.onliveData.pull_url //视频地址
                };
                console.log(_this10.isVideoBution);
                setTimeout(function () {
                    var player = new ckplayer(videoObject);
                    _this10.playVideo = new ckplayer(videoObject);
                    //   player.videoPause()
                    //    player.addVEvent('play', this.ll())
                }, 1000);
                if (_this10.onliveData.live_state == 1) {
                    _this10.isVideoBution = 0;
                    _this10.videoPoster = false;
                } else {
                    _this10.isVideoBution = 1;
                    _this10.videoPoster = true;
                }

                _this10.connect();
                // this.$refs.header.style.backgroundImage = "url('" + this.onliveData.src_img + "')"
                if (_this10.onliveData.open_status == 2 || _this10.onliveData.live_open_status == 2 || _this10.onliveData.freeze == 1) {
                    _this10.$router.replace('/forbidden/3');
                } else if (_this10.onliveData.status == 5) {
                    //已删除
                    _this10.$router.replace('/personalCenter');
                }
            });
        },
        ...
        connect: function connect() {
            ...
            _socketClient2.default.connect(this.userId, this.onliveData.code ? this.onliveData.code : '', this.courseId, this.onmessage, function () {
                ...
                if (location.hash.indexOf('/onlive/') != -1) {
                    ...
                    console.log('重连中');
                    //this.msgs =[];
                    _this11.disconnect = true;
                    if (_this11.reconnectId == null) {
                        _this11.reconnectId = setInterval(function () {
                            wx.getNetworkType({
                                success: function success(res) {
                                    console.log(res);
                                    if (_this11.reconnectId != null) {
        ...
        loseFocus: function loseFocus() {
            ...
            setTimeout(function () {
                if (_this12.commentText.length <= 0) {
                    _this12.isFocus = false;
                }
                _this12.showCommentSW = false;
            }, 100);
        },
        ...
        sendComment: function sendComment(e) {
            ...
            if (this.commentText.trim() == '') {
                ...
                if (this.teacherData.isadmin == 1) {
                    _wxfunction2.default.sendMessage(this.userId, this.courseId, this.commentText); //管理员留言
                } else {
                    _wxfunction2.default.sendMessage(this.userId, this.courseId, this.commentText);
                }
                this.commentText = '';
            }
        },
        ...
        delComment: function delComment(msgId) {
            ...
            _mintUi.MessageBox.confirm("确定删除Ta的讨论吗？", "").then(function (action) {
                _wxfunction2.default.sendMessage(+_this14.userId, +_this14.courseId, msgId + '', 8);
            }, function (cancal) {});
            $(".item-menu").removeClass("active");
        },
        ...
        forbidComment: function forbidComment(userId) {
            ...
            if (this.forbidId = userId) {
                _mintUi.MessageBox.confirm("确定禁止Ta讨论吗？", "").then(function (action) {
                    _wxfunction2.default.forbidUserChat(+_this15.userId, +_this15.courseId, 1, +userId);
                }, function (cancel) {});
                $(".item-menu").removeClass("active");
            } else {
