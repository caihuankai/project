...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), (_vm.loaded && _vm.courseList.length != 0) ? _c('div', [_c('nomore', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.courseEnd),
  ...
  })], 1) : _vm._e(), _vm._v(" "), (_vm.loaded && _vm.courseList.length == 0) ? _c('p', {
  ...
  }) : _vm._e(), _vm._v(" "), (_vm.loaded && _vm.viewList.length != 0) ? _c('div', [_c('nomore', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.viewEnd),
  ...
  })], 1) : _vm._e(), _vm._v(" "), (_vm.loaded && _vm.viewList.length == 0) ? _c('p', {
    staticClass: "nocontenttext"
  }, [_vm._v("暂无记录")]) : _vm._e()], 2) : _vm._e(), _vm._v(" "), _c('Qrcode')], 1)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-58682889", module.exports)
  }
}
...
var update = __webpack_require__(29)("02f92c3e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-58682889\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./live-recommend.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-58682889\",\"scoped\":false,\"hasInlineConfig\":true}!../../node_modules/sass-loader/lib/loader.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./live-recommend.vue");
...
Component.options.__file = "F:\\SVN\\webApp\\公众号\\dacelve1.0\\src\\live\\live-recommend.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] live-recommend.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-58682889", Component.options)
  } else {
    hotAPI.reload("data-v-58682889", Component.options)
  }
...
exports.default = {
    data: function data() {
        ...
        return _ref = {
            ...
            viewLoading: true,
            viewEnd: false
        }, _defineProperty(_ref, 'viewPage', 1), _defineProperty(_ref, 'loaded', false), _ref;
    },
    ...
    methods: {
            ...
            this.$http.get('/User/getUserLiveInfoByUserId/userId/' + this.$route.params.id).then(function (res) {
                wx.ready(function () {
                    ...
                    _this.wxShare({
                        ...
                        link: window.location.origin + '/#/live/' + _this.$route.params.id + '&' + _this.userInfoid + '?shareId=1'
                    });
                });
                wx.error();
            });
        ...
        getCourseList: function getCourseList(flag) {
            ...
            this.$http.post('/Course/getCourseRecommend', { userId: this.$route.params.id, pageNo: this.coursePage, perPage: 10, receiverType: 1 }, { emulateJSON: true }).then(function (res) {
        ...
        getViewList: function getViewList(flag) {
            ...
            this.$http.post('/Viewpoint/getViewpointRecommend', { userId: this.$route.params.id, pageNo: this.viewPage, perPage: 10, isUserInfo: true, statusIn: '1', isImageInfo: true, receiverType: 1 }, { emulateJSON: true }).then(function (res) {
                if (res.body.code == 200) {
                    _this3.loaded = true;
