...
class App
{
    ...
    private static function init($module = '')
    {
        ...
        if (is_file(APP_PATH . $module . 'init' . EXT)) {
            ...
            if (is_file(CONF_PATH . $module . 'config_merge' . CONF_EXT)){
                $config = array_merge($config, Config::load(CONF_PATH . $module . 'config_merge' . CONF_EXT));
            }
            
            // 读取数据库配置文件
            $filename = CONF_PATH . $module . 'database' . CONF_EXT;
            Config::load($filename, 'database');
            if (is_file(CONF_PATH . $module . 'database_merge' . CONF_EXT)){
                Config::load(CONF_PATH . $module . 'database_merge' . CONF_EXT, 'database');
            }
