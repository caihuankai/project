 ...
 * @method static \ThinkPHP\Query where($field, $op = null, $condition = null) 指定AND查询条件
...
abstract class Model implements \JsonSerializable, \ArrayAccess
{
    ...
    {
        $this->triggerBool = true; // 触发了事件，避免Query类没有触发
     ...
     * @return bool
     */
    public function isTriggerBool()
    {
        return $this->triggerBool;
    }
