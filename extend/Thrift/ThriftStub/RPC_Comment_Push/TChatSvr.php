...
interface TChatSvrIf {
   ...
   * @return bool
   */
  public function proc_delGroupMsg($groupid);
}
...
class TChatSvrClient implements \TChatSvrIf {
  ...
  public function proc_delGroupMsg($groupid)
  {
    $this->send_proc_delGroupMsg($groupid);
    return $this->recv_proc_delGroupMsg();
  }

  public function send_proc_delGroupMsg($groupid)
  {
    $args = new \TChatSvr_proc_delGroupMsg_args();
    $args->groupid = $groupid;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'proc_delGroupMsg', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('proc_delGroupMsg', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_proc_delGroupMsg()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\TChatSvr_proc_delGroupMsg_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \TChatSvr_proc_delGroupMsg_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("proc_delGroupMsg failed: unknown result");
  }
...
class TChatSvr_proc_delGroupMsg_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'TChatSvr_proc_delGroupMsg_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TChatSvr_proc_delGroupMsg_args');
    if ($this->groupid !== null) {
      $xfer += $output->writeFieldBegin('groupid', TType::I32, 1);
      $xfer += $output->writeI32($this->groupid);
      $xfer += $output->writeFieldEnd();
...
class TChatSvr_proc_delGroupMsg_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'TChatSvr_proc_delGroupMsg_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TChatSvr_proc_delGroupMsg_result');
    if ($this->success !== null) {
      $xfer += $output->writeFieldBegin('success', TType::BOOL, 0);
      $xfer += $output->writeBool($this->success);
      $xfer += $output->writeFieldEnd();
