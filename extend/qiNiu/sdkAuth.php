...
/**
 * 去除\Qiniu\Auth的final，改private为protected
 * 需要保持和原文件相同
 *
 * @see \Qiniu\Auth
 * @package qiNiu
...
class sdkAuth
{
     ...
     */
    protected static $policyFields = array(
        'callbackUrl',
        'callbackBody',
        'callbackHost',
        'callbackBodyType',
    ...
    protected static $deprecatedPolicyFields = array(
        'asyncOps',
    );
    
    protected static function copyPolicy(&$policy, $originPolicy, $strictPolicy)
    {
